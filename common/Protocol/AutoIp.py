...
from common.Control import logger, to_hex, PAYLOAD_OFFSET
...
class AutoIp:
    ...
    def scan(self):
        """ Sends an AutoIp brodcast and listen vor responses.
        ...
        try:
            ...
            server.sendto(msg, ('255.255.255.255', self.AUTOIP_PORT))
            logger.debug("broadcast sent! with telegram id: {}".format(TELE_ID))
                ...
                while (1):
                    ...
                    if bytes([rx[0]]) == RPL_NETSCAN or bytes([rx[0]]) == RPL_NETSCAN_COLA2:
                        ...
                        if replyTeleId == TELE_ID:
                            logger.debug("Reply-> len:{} mac:{} teleId:{}".format(replyLength, replyMac,
                                                                                  replyTeleId))
                            # print("Reply-> len:{} mac:{} teleId:{}".format(replyLength, to_hex(replyMac), to_hex(replyTeleId)))
                            # print "already found macs:", macs
                            # print "this mac:", replyMac
    ...
    def assign(self, dstMac, colaVer, ipAddr, ipMask='255.255.255.0', ipGw='0.0.0.0', dhcp=False):
        ...
        try:
            ...
            server.sendto(msg, ('<broadcast>', self.AUTOIP_PORT))
