...
class Control:
    ...
    def __init__(self, ipAddress, protocol, control_port=None, timeout=5):
    ...
    def setUseSubMM(self, useSubMM):
        """ Only for Visionary S: Sets useSubMM to True or False """
        self.writeVariable(b"useSubMM", struct.pack('B', useSubMM))
